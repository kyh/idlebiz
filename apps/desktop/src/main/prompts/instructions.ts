...
- Publishing: once the product builds, deploy it with the deploy tool. It runs Vercel with the founder's key, and the founder signs off on each deploy. If Vercel is not connected, the tool says so and the founder gets a connect card.
